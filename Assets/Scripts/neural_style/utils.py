...
def save_image(filename, data):
    status_update({
        "task": "exporting_image",
        "action": "start"
    })

    status_update({
        "task": "rendering_image",
        "action": "start"
    })
    ...
    status_update({
        "task": "creating_image_from_array",
        "action": "start"
    })
